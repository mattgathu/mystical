...
target/kernel.bin: target/multiboot_header.o target/boot.o src/asm/linker.ld cargo
	~/opt/bin/x86_64-pc-elf-ld -n -o target/kernel.bin -T src/asm/linker.ld target/multiboot_header.o target/boot.o target/x86_64-unknown-mystical-gnu/release/libmystical.a
...
cargo:
	xargo build --release --target x86_64-unknown-mystical-gnu
